...
export function Items() {
  ...
  const [foods, setFoods] = useDomainResource('items.foods', foodSchema, [{ id: 'f1', name: '鲜牛奶', location: '冰箱冷藏层', expiry: '2026-08-04' }, { id: 'f2', name: '鸡蛋', location: '冰箱蛋架', expiry: '2026-08-18' }] as Food[]);
  const [items, setItems] = useDomainResource('items.items', itemSchema, [{ id: 'i1', name: '净水器滤芯', type: '保养品', location: '厨房水槽下', detail: '上次更换：62 天前 · 周期 90 天' }, { id: 'i2', name: 'MacBook Pro', type: '固定资产', location: '书房', detail: '购入：2024-03 · 保修至 2027-03' }] as Item[]);
